...
Route::middleware('backoffice')->prefix('backoffice')->group(function () {
    ...
    // 게시글 관리 (특정 게시판)
    Route::prefix('boards/{slug}')->name('backoffice.boards.')->group(function () {
        Route::get('/posts', [BoardPostController::class, 'index'])->name('posts.index');
        Route::get('/posts/create', [BoardPostController::class, 'create'])->name('posts.create');
        Route::post('/posts', [BoardPostController::class, 'store'])->name('posts.store');
        Route::get('/posts/{post}', [BoardPostController::class, 'show'])->name('posts.show');
        Route::get('/posts/{post}/edit', [BoardPostController::class, 'edit'])->name('posts.edit');
        Route::put('/posts/{post}', [BoardPostController::class, 'update'])->name('posts.update');
        Route::delete('/posts/{post}', [BoardPostController::class, 'destroy'])->name('posts.destroy');
    });
