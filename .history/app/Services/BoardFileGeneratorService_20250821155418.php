...
class BoardFileGeneratorService
{
    ...
    private function replaceBoardVariables(string $content, Board $board): string
    {
        $replacements = [
            ...
            '{{ route(\'backoffice.board-posts.show\', [$board->slug ?? \'notice\', $post->id]) }}' => '{{ route(\'backoffice.board-posts.show\', [\'' . $board->slug . '\', $post->id]) }}',
            '{{ route(\'backoffice.board-posts.edit\', [$board->slug ?? \'notice\', $post->id]) }}' => '{{ route(\'backoffice.board-posts.edit\', [\'' . $board->slug . '\', $post->id]) }}',
            '{{ route(\'backoffice.board-posts.update\', [$board->slug ?? \'notice\', $post->id]) }}' => '{{ route(\'backoffice.board-posts.update\', [\'' . $board->slug . '\', $post->id]) }}',
            '{{ route(\'backoffice.board-posts.destroy\', [$board->slug ?? \'notice\', $post->id]) }}' => '{{ route(\'backoffice.board-posts.destroy\', [\'' . $board->slug . '\', $post->id]) }}',
            
            // 하드코딩된 라우트 치환
            'route(\'backoffice.board-posts.index\', \'notice\')' => 'route(\'backoffice.board-posts.index\', \'' . $board->slug . '\')',
            'route(\'backoffice.board-posts.create\', \'notice\')' => 'route(\'backoffice.board-posts.create\', \'' . $board->slug . '\')',
            'route(\'backoffice.board-posts.store\', \'notice\')' => 'route(\'backoffice.board-posts.store\', \'' . $board->slug . '\')',
            'route(\'backoffice.board-posts.show\', [\'notice\', $post->id])' => 'route(\'backoffice.board-posts.show\', [\'' . $board->slug . '\', $post->id])',
            'route(\'backoffice.board-posts.edit\', [\'notice\', $post->id])' => 'route(\'backoffice.board-posts.edit\', [\'' . $board->slug . '\', $post->id])',
            'route(\'backoffice.board-posts.update\', [\'notice\', $post->id])' => 'route(\'backoffice.board-posts.update\', [\'' . $board->slug . '\', $post->id])',
            'route(\'backoffice.board-posts.destroy\', [\'notice\', $post->id])' => 'route(\'backoffice.board-posts.destroy\', [\'' . $board->slug . '\', $post->id])',
        ];
