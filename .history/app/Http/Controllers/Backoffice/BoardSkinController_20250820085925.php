...
class BoardSkinController extends BaseController
{
    ...
    public function index()
    {
        ...
        return $this->view('backoffice.board_skins.index', compact('skins'));
    }
    ...
    {
        return $this->view('backoffice.board_skins.create');
    }
    ...
    {
        return $this->view('backoffice.board_skins.show', compact('boardSkin'));
    }
    ...
    {
        return $this->view('backoffice.board_skins.edit', compact('boardSkin'));
    }
    ...
    public function editTemplate(Request $request, BoardSkin $boardSkin)
    {
        ...
        return $this->view('backoffice.board_skins.edit_template', compact('boardSkin', 'template', 'content'));
    }
