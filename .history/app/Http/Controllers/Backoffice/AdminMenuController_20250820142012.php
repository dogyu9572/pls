...
class AdminMenuController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('backoffice.menus.index', ['show_modal' => time()])
            ->with('modal_message', '메뉴가 성공적으로 생성되었습니다.');
    }
    ...
    public function update(Request $request, AdminMenu $menu)
    {
        ...
        return redirect()->route('backoffice.menus.index')
            ->with('modal_message', '메뉴가 성공적으로 수정되었습니다.');
    }
    ...
    public function destroy(AdminMenu $menu)
    {
        ...
        return redirect()->route('backoffice.menus.index', ['show_modal' => time()])
            ->with('modal_message', '메뉴가 성공적으로 삭제되었습니다.');
    }
