...
class AdminMenuController extends BaseController
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('backoffice.menus.index', ['success' => 'create'])
    ...
    public function update(Request $request, AdminMenu $menu)
    {
        ...
        return redirect()->route('backoffice.menus.index', ['success' => 'edit'])
    ...
    public function destroy(AdminMenu $menu)
    {
        ...
        return redirect()->route('backoffice.menus.index', ['success' => 'delete'])
