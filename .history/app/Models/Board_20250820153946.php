...
class Board extends Model
{
    ...
    {
        return "boards.instances.{$this->table_name}.{$viewType}";
    }
    ...
    {
        $customSkinPath = resource_path("views/boards/instances/{$this->table_name}");
    ...
    /**
     * table_name이 중복되지 않는지 확인합니다 (삭제된 데이터 제외).
     */
    public static function isTableNameAvailable($tableName, $excludeId = null)
    {
        $query = self::where('table_name', $tableName);
