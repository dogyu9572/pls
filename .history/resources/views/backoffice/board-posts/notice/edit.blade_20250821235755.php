                        ...
                        <div class="board-form-group">
                                            ...
                                            @if(!empty($option))
                                                <div class="board-option-item">
                                                    <input type="checkbox" 
                                                           ...
                                                           name="custom_field_{{ $fieldConfig['name'] }}[]" 
                                                           value="{{ $option }}"
                                                           {{ in_array($option, old('custom_field_' . $fieldConfig['name'], $post->custom_fields[$fieldConfig['name']] ?? [])) ? 'checked' : '' }}
                                                           @if($fieldConfig['required']) required @endif>
                                ...
                                @else
                                    <div class="board-checkbox-item">
                                        <input type="checkbox" 
                                               ...
                                               name="custom_field_{{ $fieldConfig['name'] }}" 
                                               value="1"
                                               {{ old('custom_field_' . $fieldConfig['name'], $post->custom_fields[$fieldConfig['name']] ?? '') == '1' ? 'checked' : '' }}
                                               @if($fieldConfig['required']) required @endif>
                                        <label for="custom_field_{{ $fieldConfig['name'] }}" class="board-form-label">
                                            {{ $fieldConfig['label'] }}
                                        </label>
                                            ...
                                            @if(!empty($option))
                                                <div class="board-option-item">
                                                    <input type="radio" 
                                                           ...
                                                           name="custom_field_{{ $fieldConfig['name'] }}" 
                                                           value="{{ $option }}"
                                                           {{ old('custom_field_' . $fieldConfig['name'], $post->custom_fields[$fieldConfig['name']] ?? '') == $option ? 'checked' : '' }}
                                                           @if($fieldConfig['required']) required @endif>
                                                    <label for="option_{{ $fieldConfig['name'] }}_{{ $loop->index }}">{{ $option }}</label>
                                                </div>
                                            @endif
                            ...
                            @elseif($fieldConfig['type'] === 'date')
                                <input type="date" 
                                       ...
                                       id="custom_field_{{ $fieldConfig['name'] }}" 
                                       name="custom_field_{{ $fieldConfig['name'] }}" 
                                       value="{{ old('custom_field_' . $fieldConfig['name'], $post->custom_fields[$fieldConfig['name']] ?? '') }}"
                                       @if($fieldConfig['required']) required @endif>
                            @endif
