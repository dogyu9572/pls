                        ...
                        <tbody>
                            @forelse($posts as $post)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('backoffice.board-posts.show', ['notice', $post->id]) }}"
                                    ...
                                    <td>
                                        <div class="board-btn-group">
                                            ...
                                            <a href="{{ route('backoffice.board-posts.edit', ['notice', $post->id]) }}"
                                                class="btn btn-primary btn-sm">
                                                <i class="fas fa-edit"></i> 수정
                                            </a>
                                            <form
                                                action="{{ route('backoffice.board-posts.destroy', ['notice', $post->id]) }}"
