...
<div class="board-container">
    <div class="board-header">
        <a href="http://localhost/backoffice/board-posts/test" class="btn btn-secondary">
    ...
    <div class="board-card">
        ...
        <div class="board-card-body">
            ...
            <form action="http://localhost/backoffice/board-posts/test" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="board-form-actions">
                    ...
                    <a href="http://localhost/backoffice/board-posts/test" class="btn btn-secondary">취소</a>
                </div>
            </form>
        </div>
    </div>
