                    ...
                    <div class="board-file-upload">
                        ...
                        @if($post->attachments)
                            <div class="existing-attachments">
                                <h6>기존 첨부파일</h6>
                                @foreach(json_decode($post->attachments, true) ?? [] as $index => $attachment)
                                    <div class="existing-attachment-item">
                                        <span>{{ $attachment['name'] }}</span>
                                        <button type="button" class="btn btn-sm btn-outline-danger" onclick="removeExistingAttachment({{ $index }})">
