...
<div class="board-container">
    <div class="board-header">        
        <a href="{{ route('backoffice.admin-menus.create') }}" class="btn btn-success">
                ...
                <ul id="mainMenuList" class="menu-list">
                    ...
                    <li class="menu-item" data-id="{{ $menu->id }}">
                        ...
                        <div class="board-btn-group">
                            <a href="{{ route('backoffice.admin-menus.edit', $menu) }}" class="btn btn-primary btn-sm">
                                <i class="fas fa-edit"></i> 수정
                            </a>
                            <form action="{{ route('backoffice.admin-menus.destroy', $menu) }}" method="POST" class="d-inline" onsubmit="return confirm('정말 이 메뉴를 삭제하시겠습니까?');">
                                @csrf
                                @method('DELETE')
                        ...
                        <li>
                            <ul class="submenu-list" data-parent-id="{{ $menu->id }}">
                                ...
                                <li class="submenu-item" data-id="{{ $child->id }}">
                                    ...
                                    <div class="board-btn-group">
                                        <a href="{{ route('backoffice.admin-menus.edit', $child) }}" class="btn btn-primary btn-sm">
                                            <i class="fas fa-edit"></i> 수정
                                        </a>
                                        <form action="{{ route('backoffice.admin-menus.destroy', $child) }}" method="POST" class="d-inline" onsubmit="return confirm('정말 이 메뉴를 삭제하시겠습니까?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm">
                                                <i class="fas fa-trash"></i> 삭제
