        ...
        <div class="board-card-body">
            <form action="{{ route('backoffice.menus.update', $menu) }}" method="POST">
                ...
                <div class="board-form-group">
                    ...
                    <div class="url-input-group" style="display: flex; align-items: center; gap: 10px;">
                        <select class="board-form-control" id="url_prefix" style="width: 150px; flex-shrink: 0;">
                            <option value="">직접 입력</option>
                            <option value="admin">관리자</option>
                            <option value="board">게시판</option>
                            <option value="external">외부 URL</option>
                        </select>
                        <input type="text" class="board-form-control" id="url" name="url" value="{{ old('url', $menu->url) }}" placeholder="URL을 입력하거나 위에서 선택하세요" style="flex: 1;">
                    </div>
