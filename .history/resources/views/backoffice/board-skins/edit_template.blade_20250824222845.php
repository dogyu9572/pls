...
<div class="skin-container">
    <div class="skin-header">
        ...
        <div class="skin-header-right">
            <div class="skin-tabs">
                <a href="{{ route('backoffice.board-skins.edit_template', ['boardSkin' => $boardSkin->id, 'template' => 'list']) }}" class="skin-btn {{ $template == 'list' ? 'skin-btn-primary' : 'skin-btn-secondary' }}">
                    <i class="fas fa-list"></i> 목록 템플릿
                </a>
                <a href="{{ route('backoffice.board-skins.edit_template', ['boardSkin' => $boardSkin->id, 'template' => 'view']) }}" class="skin-btn {{ $template == 'view' ? 'skin-btn-primary' : 'skin-btn-secondary' }}">
                    <i class="fas fa-eye"></i> 보기 템플릿
                </a>
                <a href="{{ route('backoffice.board-skins.edit_template', ['boardSkin' => $boardSkin->id, 'template' => 'write']) }}" class="skin-btn {{ $template == 'write' ? 'skin-btn-primary' : 'skin-btn-secondary' }}">
                    <i class="fas fa-edit"></i> 작성 템플릿
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="skin-content">
        <form action="{{ route('backoffice.board-skins.update_template', $boardSkin) }}" method="POST">
            @csrf
