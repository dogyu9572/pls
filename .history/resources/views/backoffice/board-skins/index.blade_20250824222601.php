...
<div class="board-container">
    <div class="board-header">
        <h1>스킨 관리</h1>
        <a href="{{ route('backoffice.board-skins.create') }}" class="btn btn-success">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="board-btn-group">
                                        <a href="{{ route('backoffice.board-skins.edit', $skin) }}" class="btn btn-primary btn-sm">
                                            <i class="fas fa-edit"></i> 수정
                                        </a>
                                        <form action="{{ route('backoffice.board-skins.destroy', $skin) }}" method="POST" class="d-inline" onsubmit="return confirm('정말 이 스킨을 삭제하시겠습니까?');">
                                            @csrf
                                            @method('DELETE')
