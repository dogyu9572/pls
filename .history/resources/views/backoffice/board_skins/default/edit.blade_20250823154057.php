                                            ...
                                            @if(!empty($option))
                                                <div class="board-option-item">
                                                    <input type="checkbox" 
                                                           ...
                                                           name="custom_field_{{ $fieldConfig['name'] }}[]" 
                                                           value="{{ $option }}"
                                                           {{ (is_array($fieldValue) && in_array($option, $fieldValue)) || $fieldValue == $option || in_array($option, old('custom_field_' . $fieldConfig['name'], [])) ? 'checked' : '' }}
                                                           @if($fieldConfig['required']) required @endif>
                                ...
                                @else
                                    <div class="board-checkbox-item">
                                        <input type="checkbox" 
                                               ...
                                               name="custom_field_{{ $fieldConfig['name'] }}" 
                                               value="1"
                                               {{ $fieldValue == '1' || $fieldValue == 1 || old('custom_field_' . $fieldConfig['name']) == '1' ? 'checked' : '' }}
                                               @if($fieldConfig['required']) required @endif>
                                        <label for="custom_field_{{ $fieldConfig['name'] }}" class="board-form-label">
                                            {{ $fieldConfig['label'] }}
                                        </label>
