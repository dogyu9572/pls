                        ...
                        <div class="board-form-group">
                            ...
                            @if($fieldConfig['type'] === 'text')
                                <input type="text" 
                                       ...
                                       oninput="limitKoreanChars(this, {{ $fieldConfig['max_length'] ?? 255 }})"
                                ...
                                @else
                                    <div class="board-checkbox-item">
                                        <input type="checkbox" 
                                               ...
                                               name="custom_field_{{ $fieldConfig['name'] }}" 
                                               value="1"
                                               {{ (is_array($fieldConfig['name']) ? in_array('1', $fieldConfig['name']) : $fieldConfig['name'] == '1' || $fieldConfig['name'] == 1) || (is_array(old('custom_field_' . $fieldConfig['name'])) ? in_array('1', old('custom_field_' . $fieldConfig['name'])) : old('custom_field_' . $fieldConfig['name']) == '1') ? 'checked' : '' }}
                                               @if($fieldConfig['required']) required @endif>
                                        <label for="custom_field_{{ $fieldConfig['name'] }}" class="board-form-label">
                                            {{ $fieldConfig['label'] }}
                                        </label>
                                            ...
                                            @if(!empty($option))
                                                <div class="board-option-item">
                                                    <input type="radio" 
                                                           ...
                                                           name="custom_field_{{ $fieldConfig['name'] }}" 
                                                           value="{{ $option }}"
                                                           {{ (is_array($fieldConfig['name']) ? in_array($option, $fieldConfig['name']) : $fieldConfig['name'] == $option) || (is_array(old('custom_field_' . $fieldConfig['name'])) ? in_array($option, old('custom_field_' . $fieldConfig['name'])) : old('custom_field_' . $fieldConfig['name']) == $option) ? 'checked' : '' }}
                                                           @if($fieldConfig['required']) required @endif>
                                                    <label for="option_{{ $fieldConfig['name'] }}_{{ $loop->index }}">{{ $option }}</label>
                                                </div>
                                            @endif
...
@push('scripts')
    ...
    <script>
        // 한글 글자 수 제한 함수
        function limitKoreanChars(input, maxLength) {
