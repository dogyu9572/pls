                ...
                <div class="board-card-body">
                    <form action="{{ route('backoffice.boards.update', $board) }}" method="POST">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-col form-col-6">
                                <div class="form-group">
                                    <label for="table_name" class="form-label">테이블명 <span class="required">*</span></label>
                                    <input type="text" class="form-control" id="table_name" name="table_name" value="{{ old('table_name', $board->table_name) }}" required>
