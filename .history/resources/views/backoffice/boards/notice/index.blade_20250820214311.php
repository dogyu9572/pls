...
<div class="board-container">
    <div class="board-header">       
                            <a href="{{ route('backoffice.boards.create', 'notice') }}" class="btn btn-success">
    ...
    <div class="board-card">
        ...
        <div class="board-card-body">
            ...
            <div class="board-filter">
                <form method="GET" action="{{ route('backoffice.boards.index', 'notice') }}" class="filter-form">
                            ...
                            <div class="filter-buttons">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-search"></i> 검색
                                                        ...
                                                        <a href="{{ route('backoffice.boards.index', 'notice') }}" class="btn btn-secondary">
                ...
                <table class="board-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @if($post->is_notice)
                                    <span class="status-badge status-notice">공지</span>
                                @else
                                    <span class="status-badge status-general">일반</span>
                                @endif
                            </td>
                            <td>
                                <a href="{{ route('backoffice.boards.posts.show', ['notice', $post->id]) }}" class="text-decoration-none">
                                    {{ $post->title }}
                                </a>
                            </td>
                            ...
                            <td>
                                <div class="board-btn-group">
                                    <a href="{{ route('backoffice.boards.posts.show', ['notice', $post->id]) }}" class="btn btn-info btn-sm">
                                        <i class="fas fa-eye"></i> 보기
                                    </a>
                                    <a href="{{ route('backoffice.boards.posts.edit', ['notice', $post->id]) }}" class="btn btn-primary btn-sm">
                                        <i class="fas fa-edit"></i> 수정
                                    </a>
                                    <form action="{{ route('backoffice.boards.posts.destroy', ['notice', $post->id]) }}" method="POST" class="d-inline" onsubmit="return confirm('정말 이 게시글을 삭제하시겠습니까?');">
                                        @csrf
                                        @method('DELETE')
