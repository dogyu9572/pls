...
<div class="board-container">
    <div class="board-header">       
        <a href="{{ route('backoffice.boards.posts.create', 'notice') }}" class="btn btn-success">
    ...
    <div class="board-card">
        ...
        <div class="board-card-body">
            ...
            <div class="board-filter">
                <form method="GET" action="{{ route('backoffice.boards.posts.index', 'notice') }}" class="filter-form">
