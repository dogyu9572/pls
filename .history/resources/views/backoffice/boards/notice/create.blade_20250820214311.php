...
<div class="board-container">
    ...
    <div class="board-card">
        ...
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.boards.store', 'notice') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="board-form-actions">
                    ...
                    <a href="{{ route('backoffice.boards.index', 'notice') }}" class="btn btn-secondary">취소</a>
                </div>
            </form>
        </div>
    </div>
