...
@section('content')
    ...
    <div class="board-container">
        <div class="notice-board-header">
            <div class="notice-board-buttons">
        ...
        <div class="board-card">
            <div class="board-card-header">
                <div class="notice-board-card-title">
                    <h6>공지사항</h6>
                    <span class="notice-board-count">총 {{ $posts->total() }}개</span>
                </div>
            </div>
...
@push('scripts')
    <script src="{{ asset('js/backoffice/notice-board.js') }}"></script>
@endpush
