...
<div class="board-container">
    ...
    <div class="board-card">
        ...
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.boards.posts.store', 'notice') }}" method="POST">
                @csrf
                ...
                <div class="board-form-group">
                    <div class="board-checkbox-item">
                        ...
                        <label for="is_notice" class="board-form-label">공지사항으로 등록</label>
                    </div>
                    <small class="board-form-text">체크하면 이 게시글이 공지사항으로 표시됩니다.</small>
                </div>
