                        ...
                        <tbody>
                            @forelse($posts as $post)
                                <tr>
                                    <td>
                                        @if ($post->is_notice)
                                            <span style="color: #28a745; font-weight: 600; background-color: #d4edda; padding: 2px 6px; border-radius: 4px; font-size: 12px; display: inline; margin-right: 5px; line-height: 1;">공지</span>
                                        @else
                                            {{ $post->id }}
                                        @endif
                                    </td>
