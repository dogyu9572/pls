                    ...
                    <form action="{{ route('backoffice.boards.update', $board) }}" method="POST">
                        ...
                        <div class="board-form-group">
                            ...
                            <div class="custom-fields-container">
                                                ...
                                                <div class="board-form-row">
                                                    ...
                                                    <div class="board-form-col board-form-col-4">
                                                        <div class="board-form-group">
                                                            ...
                                                            <input type="number" class="board-form-control" name="custom_fields[{{ $index }}][max_length]" value="{{ $fieldConfig['max_length'] ?? '' }}" placeholder="예: 50" min="1" max="255">
                                                        </div>
                                                    </div>
                                                    <div class="board-form-col board-form-col-4">
                                                        <div class="board-form-group">
                                ...
                                <button type="button" class="btn btn-outline-primary btn-sm" id="addCustomFieldBtn" onclick="console.log('onclick 실행됨'); addCustomField();">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        console.log('커스텀 필드 버튼 찾는 중...');
        const addCustomFieldBtn = document.getElementById('addCustomFieldBtn');
        console.log('찾은 버튼:', addCustomFieldBtn);
        ...
        if (addCustomFieldBtn) {
            ...
            console.error('addCustomFieldBtn을 찾을 수 없습니다!');
        }
    });
    ...
    function addCustomField() {
        console.log('addCustomField 함수 실행됨');
        ...
        console.log('기존 필드 개수:', existingFields);
        
        const fieldId = 'custom_field_' + customFieldCounter++;
        console.log('새 필드 ID:', fieldId);
            ...
            <div class="custom-field-item" id="${fieldId}">
                ...
                <div class="board-form-row">
                    ...
                    <div class="board-form-col board-form-col-4">
                        <div class="board-form-group">
                            <label class="board-form-label">최대 길이</label>
                            <input type="number" class="board-form-control" name="custom_fields[${existingFields}][max_length]" placeholder="예: 50" min="1" max="255">
                        </div>
                    </div>
                    <div class="board-form-col board-form-col-4">
                        <div class="board-form-group">
        ...
        console.log('생성된 HTML:', fieldHtml);
        container.insertAdjacentHTML('beforeend', fieldHtml);
        console.log('필드 추가 완료. 현재 필드 개수:', container.children.length);
    }
