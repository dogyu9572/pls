        ...
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.boards.store') }}" method="POST">
                ...
                <div class="board-form-row">
                    ...
                    <div class="board-form-col board-form-col-6">
                        <div class="board-form-group">
                            <label for="table_name" class="board-form-label">테이블명 <span class="required">*</span></label>
                            <input type="text" class="board-form-control" id="table_name" name="table_name" value="{{ old('table_name') }}" required>
