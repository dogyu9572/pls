...
<div class="board-container">
    <div class="board-header">
        <h1>게시판 관리</h1>
        <a href="{{ route('backoffice.boards.create') }}" class="board-add-btn">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="board-btn-group">
                                    <a href="{{ route('boards.index', $board->slug) }}" target="_blank" class="board-btn board-btn-success">
                                        <i class="fas fa-external-link-alt"></i> <span class="btn-text">보기</span>
                                    </a>
                                    <a href="{{ route('backoffice.boards.edit', $board) }}" class="board-btn board-btn-primary">
                                    ...
                                    <form action="{{ route('backoffice.boards.destroy', $board) }}" method="POST" class="d-inline" onsubmit="return confirm('이 게시판을 삭제하시겠습니까? 관련된 모든 데이터가 함께 삭제됩니다.');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="board-btn board-btn-danger">
