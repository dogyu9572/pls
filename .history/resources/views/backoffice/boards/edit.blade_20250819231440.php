    ...
    <div class="row">
                            ...
                            <div class="board-form-col board-form-col-4">
                                <div class="board-form-group">
                                    ...
                                    <div class="board-radio-group">
                                        ...
                                        <div class="board-radio-item">
                                            <input type="radio" id="permission_read_member" name="permission_read" value="member" class="board-radio-input" {{ old('permission_read', $board->permission_read) == 'all' ? 'checked' : '' }}>
                            ...
                            <div class="board-form-col board-form-col-4">
                                <div class="board-form-group">
                                    ...
                                    <div class="board-radio-group">
                                        ...
                                        <div class="board-radio-item">
                                            <input type="radio" id="permission_comment_admin" name="permission_comment" value="admin" class="board-radio-input" {{ old('permission_comment', $board->permission_write) == 'admin' ? 'checked' : '' }}>
        ...
        <div class="col-md-4">
            ...
            <div class="board-card">
                ...
                <div class="board-card-body">
                    <div class="mb-3">
                        <a href="{{ route('boards.index', $board->slug) }}" target="_blank" class="btn btn-success">
