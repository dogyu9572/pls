        ...
        <div class="card-body">
            ...
            <form action="{{ route('backoffice.boards.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control form-textarea" id="description" name="description" rows="2">{{ old('description') }}</textarea>
                </div>
                ...
                <div class="form-row">
                    ...
                    <div class="form-col form-col-6">
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="list_count" name="list_count" value="{{ old('list_count', default: 15) }}" min="5" max="100">
                        </div>
                    </div>
                </div>
