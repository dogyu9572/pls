                        ...
                        <tr>
                            ...
                            <td>
                                <div class="board-btn-group">
                                    <a href="{{ route('boards.index', $board->table_name) }}" target="_blank" class="btn btn-info btn-sm">
                                        <i class="fas fa-eye"></i> 보기
                                    </a>
                                    <a href="{{ route('backoffice.boards.posts.index', $board->table_name) }}" class="btn btn-warning btn-sm">
