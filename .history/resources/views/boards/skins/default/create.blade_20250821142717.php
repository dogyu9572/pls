...
@section('title', ($board->name ?? '게시판') . ' - 게시글 작성')
...
<div class="board-container">
    <div class="board-header">
        <a href="{{ route('backoffice.board_posts.index', $board->slug ?? 'notice') }}" class="btn btn-secondary">
    ...
    <div class="board-card">
        ...
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.board_posts.store', $board->slug ?? 'notice') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="board-form-actions">
                    ...
                    <a href="{{ route('backoffice.board_posts.index', $board->slug ?? 'notice') }}" class="btn btn-secondary">취소</a>
                </div>
            </form>
        </div>
    </div>
