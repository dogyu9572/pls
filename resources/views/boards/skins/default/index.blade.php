    ...
    <div class="board-container">
        <div class="board-page-header">
            <div class="board-page-buttons">
                ...
                <a href="{{ route('backoffice.board_posts.create', $board->slug ?? 'notice') }}" class="btn btn-success">
        ...
        <div class="board-card">
            ...
            <div class="board-card-body">
                ...
                <div class="board-filter">
                    <form method="GET" action="{{ route('backoffice.board_posts.index', $board->slug ?? 'notice') }}" class="filter-form">
                        <div class="filter-row">
                            ...
                            <div class="filter-group">
                                <div class="filter-buttons">
                                    ...
                                    <a href="{{ route('backoffice.board_posts.index', $board->slug ?? 'notice') }}"
                        ...
                        <tbody>
                            @forelse($posts as $post)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('backoffice.board_posts.show', [$board->slug ?? 'notice', $post->id]) }}"
                                    ...
                                    <td>
                                        <div class="board-btn-group">
                                            ...
                                            <a href="{{ route('backoffice.board_posts.edit', [$board->slug ?? 'notice', $post->id]) }}"
                                                class="btn btn-primary btn-sm">
                                                <i class="fas fa-edit"></i> 수정
                                            </a>
                                            <form
                                                action="{{ route('backoffice.board_posts.destroy', [$board->slug ?? 'notice', $post->id]) }}"
