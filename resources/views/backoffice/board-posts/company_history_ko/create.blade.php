    ...
    <div class="board-card">
        ...
        <div class="board-card-body">
            ...
            <form action="{{ route('backoffice.board-posts.store', $board->slug ?? 'notice') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="board-form-group">
                    <label for="category" class="board-form-label">연도 <span class="required">*</span></label>
                    <select class="board-form-control" id="category" name="category" required>
                        <option value="">연도를 선택하세요</option>
                        @for($year = date('Y'); $year >= 1990; $year--)
                            <option value="{{ $year }}" {{ old('category') == $year ? 'selected' : '' }}>
                                {{ $year }}년
                            </option>
                        @endfor
                    </select>
                ...
                <!-- 제목 필드 숨김 처리 -->
                <input type="hidden" name="title" value="회사연혁">
                ...
                <div class="board-form-group">
                    ...
                    <input type="number" class="board-form-control" id="sort_order" name="sort_order" value="{{ old('sort_order', $nextSortOrder ?? 1) }}" min="0">
                ...
                <div class="board-form-group">
                    <label class="board-form-label">이미지</label>
                    <div class="board-file-upload">
                        <div class="board-file-input-wrapper">
                            <input type="file" class="board-file-input" id="attachments" name="attachments[]" accept=".jpg,.jpeg,.png,.gif">
